...
class SentencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sentence" do
    assert_difference('Sentence.count') do
      post sentences_url, params: { sentence: { publication_id: @sentence.publication_id, text: @sentence.text } }
    end
  ...
  test "should update sentence" do
    patch sentence_url(@sentence), params: { sentence: { publication_id: @sentence.publication_id, text: @sentence.text } }
